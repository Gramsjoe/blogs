...
def training_function(args):
    ...
    teacher_model = AutoModelForSequenceClassification.from_pretrained(args.teacher_model_id,
                                                                       num_labels=2,
                                                                       id2label=id2label,
                                                                       label2id=label2id,
                                                                       cache_dir="/tmp",
    ...
    student_model = AutoModelForSequenceClassification.from_pretrained(args.student_model_id,
                                                                       num_labels=2,
                                                                       id2label=id2label,
                                                                       label2id=label2id,
                                                                       cache_dir="/tmp",
    ...
    student_model = tsm.transform(student_model)
